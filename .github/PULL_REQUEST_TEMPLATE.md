...
- **Fresh rebuild:** <!-- confirm R9: the binary was REBUILT from this source (`task build:binary`) and `charly version` matches; and the gate ran on a FRESH `charly update`/rebuild, at ZERO warnings. -->
